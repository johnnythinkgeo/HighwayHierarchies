...
* @author Keith Schwarz (htiek@cs.stanford.edu)
*/
public final class FibonacciHeapNew<T> {
    ...
    *         heaps.
    */
   public static <T> FibonacciHeapNew<T> merge(FibonacciHeapNew<T> one, FibonacciHeapNew<T> two) {
       /* Create a new FibonacciHeap to hold the result. */
	   FibonacciHeapNew<T> result = new FibonacciHeapNew<T>();
